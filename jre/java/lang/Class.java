...
//    }
    ...
    /* javsvm-removed: we don't store ClassLoader object */
//    /*
...
//    private volatile transient Class<?>       newInstanceCallerCache;
     ...
     */
    /* javsvm-changed: use getModifier() and INTERFACE flag */
//    public native boolean isInterface();
    public boolean isInterface() {
        final int INTERFACE = 0x00000200;
        return (getModifiers() & INTERFACE) != 0;
    }
    /* javsvm-changed: end */
    ...
    /* javsvm-changed: we don't store ClassLoader object */
...
//    private final ClassLoader classLoader;
     ...
     * @since 1.5
     */
    /* javsvm-changed: implements in native */
...
//    }
     ...
     * @since JDK1.1
     */
    /* javsvm-changed: add cache */
//    public native int getModifiers();

    private transient int mModifiers = -1;
    public int getModifiers() {
        int modifiers = mModifiers;
        if (modifiers == -1) {
            modifiers = mModifiers = getModifiers0();
        }
        return modifiers;
    }
     ...
     * @since   JDK1.1
     */
    /* javsvm-removed: unsupported */
    public Object[] getSigners() {
        throw new UnsupportedOperationException("getSigners()");
    }
...
//    native void setSigners(Object[] signers);
     ...
     */
    @CallerSensitive
    public native Method getEnclosingMethod() throws SecurityException;
...
//    }
    ...
    public boolean isAnonymousClass() {
        /* javsvm-changed: use String.size() */
//        return "".equals(getSimpleName());
    ...
    private boolean isLocalOrAnonymousClass() {
        ...
        // attribute if and only if it is a local class or an
        // anonymous class.
        /* javsvm-changed: use getEnclosingMethod() instead. */
...
//        return copyFields(privateGetPublicFields(null));
    ...
    private native Field[] getFields0();
...
//        return copyMethods(privateGetPublicMethods());
    ...
    private native Method[] getMethods0();
...
//        return copyConstructors(privateGetDeclaredConstructors(true));
        return getConstructors0();
    }
    private native Constructor<?>[] getConstructors0();
...
//        Method method = getMethod0(name, parameterTypes, true);
    ...
    private native Method getMethod0(String name, Class<?>[] params);
...
//        return getConstructor0(parameterTypes, Member.PUBLIC);
        Constructor<T> cons = getConstructor0(parameterTypes);
        if (cons == null) {
            throw new NoSuchMethodException(getName() + ".<init>" + argumentTypesToString(parameterTypes));
        }
        return cons;
    }
    private native Constructor<T> getConstructor0(Class<?>... parameterTypes);
...
//        return copyConstructors(privateGetDeclaredConstructors(false));
    ...
    private native Constructor<?>[] getDeclaredConstructors0();
...
//        Field field = searchFields(privateGetDeclaredFields(false), name);
        Field field = getDeclaredField0(name);
        if (field == null) {
            throw new NoSuchFieldException(name);
        }
        return field;
    }
    private native Field getDeclaredField0(String name);
...
//        Method method = searchMethods(privateGetDeclaredMethods(false), name, parameterTypes);
        Method method = getDeclaredMethod0(name, parameterTypes);
        if (method == null) {
            throw new NoSuchMethodException(getName() + "." + name + argumentTypesToString(parameterTypes));
        }
        return method;
    }
    private native Method getDeclaredMethod0(String name, Class<?>... parameterTypes);
...
//        return getConstructor0(parameterTypes, Member.DECLARED);
        Constructor<T> con = getDeclaredConstructor0(parameterTypes);
        if (con == null) {
            throw new NoSuchMethodException(getName() + ".<init>" + argumentTypesToString(parameterTypes));
        }
        return con;
    ...
    private native Constructor<T> getDeclaredConstructor0(Class<?>... parameterTypes);
    ...
    T[] getEnumConstantsShared() {
        if (enumConstants == null) {
            ...
            try {
                ...
                /* javsvm-changed: access always granted */
...
//                        });
    ...
    public T cast(Object obj) {
        if (obj != null && !isInstance(obj))
            /* javsvm-changed: inline cannotCastMsg() */
...
//    }
    ...
    /* javsvm-changed: implements in native */
    @Override
    public native <A extends Annotation> A[] getAnnotationsByType(Class<A> annotationClass);
//    @Override
